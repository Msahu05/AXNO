...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-purple-soft/40 dark:bg-background">
        ...
        <section id="support" className="rounded-[40px] border border-border dark:border-white/15 bg-[var(--card)]/95 p-8 shadow-[var(--shadow-soft)]">
          <div className="flex flex-wrap items-center justify-between gap-6">
            ...
            <div className="flex gap-4">
              <Button className="rounded-lg bg-[#25D366] px-6 py-4 text-sm font-semibold text-white shadow-lg flex items-center gap-2" onClick={() => window.open("https://wa.me/917016925325", "_blank")}>
              ...
              <Button variant="outline" className="rounded-lg border border-border px-6 py-4 text-sm font-semibold text-foreground flex items-center gap-2" onClick={() => window.open("tel:+917016925325", "_self")}>
      ...
      {/* Social Media Footer */}
      <section className="w-full border-t border-border dark:border-white/15 bg-gradient-to-r from-purple-900/30 via-purple-800/30 to-purple-900/30 dark:from-[#1a1625] dark:via-[#2a2538] dark:to-[#1a1625] py-2 px-6">
        <div className="flex flex-col items-center justify-center gap-2 bg-purple-800 dark:bg-purple-950 rounded-lg py-3 px-4">
